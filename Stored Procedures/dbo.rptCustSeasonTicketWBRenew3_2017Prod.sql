...
CREATE PROCEDURE [dbo].[rptCustSeasonTicketWBRenew3_2017Prod] 
    (
      @startDate DATE
    , @endDate DATE
...
(eventcode)
select '17WBWB01'  union all 
select '17WBWB02'  union all 
select '17WBWB03'  union all 
select '17WBWB04'  union all 
select '17WBWB05'  union all 
select '17WBWB06'  union all 
select '17WBWB07'  union all
select '17WBWB08'  union all 
select '17WBWB09'  union all 
select '17WBWB10'  union all 
select '17WBWB11'  union all 
select '17WBWB12'  union all 
select '17WBWB13'  union all 
select '17WBWB14'  union all
select '17WBWB15'  UNION ALL
SELECT '17WBWB16' 
...
SELECT '17WBWB01'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB02'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB03'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB04'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB05'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB06'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB07'	,'0'	,'0'  UNION ALL
SELECT '17WBWB08'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB09'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB10'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB11'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB12'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB13'	,'0'	,'0'  UNION ALL 
SELECT '17WBWB14'	,'0'	,'0'  UNION ALL
SELECT '17WBWB15'	,'0'	,'0'  UNION ALL
SELECT '17WBWB16'	,'0'	,'0'
