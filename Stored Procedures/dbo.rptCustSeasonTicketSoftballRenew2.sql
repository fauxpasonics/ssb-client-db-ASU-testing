...
CREATE PROCEDURE [dbo].[rptCustSeasonTicketSoftballRenew2] 
(
  @startDate DATE
, @endDate DATE
...
-- =============================================
-- Created By: Keegan Schmitt/Abbey Meitin
-- Create Date: ??
-- Reviewed By: Abbey Meitin
-- Reviewed Date: ??
-- Description: ASU Softball HOB Report Sproc 2 of 4
-- =============================================
 
/***** Revision History
 
Ashlee Oneill on 2018-07-30: Removed PrevSeason Param, Reviewed By: Abbey Meitin - 2018-07-30
...
set @Sport = 'Softball'
DECLARE @prevSeason VARCHAR(50) = (cast(@curSeason as int)-1)
...
UNION 
  ...
  SELECT DISTINCT x.SeasonYear
			,x.PL_CLASS
              , x.PC1
        FROM    ( SELECT    fts.SeasonYear
								,CASE WHEN fts.PriceLevelCode = '1'	THEN 'Premium Field'
                                 WHEN fts.PriceLevelCode = '2'		THEN 'Field'
                                 WHEN fts.PriceLevelCode = '3'		THEN 'Bleacher Reserved'
                                 WHEN fts.PriceLevelCode = '4'		THEN 'Students'
								 WHEN fts.PriceLevelCode = '5'		THEN 'General Admission'
                                 ELSE 'Unknown'
                            END AS PL_CLASS
