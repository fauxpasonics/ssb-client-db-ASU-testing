...
CREATE PROCEDURE [rpt].[DOMO_Pac12_ASU_Football14_15_TicketSales_SeatInventory]
AS
    BEGIN
    ...
    --          , SSBID.SSB_CRMSYSTEM_CONTACT_ID
        ...
        FROM    [172.31.17.15].ASU.[dbo].[DOMO_Pac12_ASU_Football14_15_TicketSales_SeatInventory] DOMO WITH (NOLOCK)
