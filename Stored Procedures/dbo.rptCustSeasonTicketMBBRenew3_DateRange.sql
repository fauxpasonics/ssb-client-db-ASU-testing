...
CREATE  PROCEDURE [dbo].[rptCustSeasonTicketMBBRenew3_DateRange]
...
( 
eventCode varchar(100) COLLATE SQL_Latin1_General_CP1_CS_AS
...
join
(select a.eventCode, (SUM(isnull(b.groupTicketAmt,0) + isnull(b.publicTicketAmt,0)+ isnull(b.studentAmt,0))) - (SUM(isnull(b.budgetAvg,0))) as varianceYTD, SUM(isnull(b.budgetAvg,0)) as budgetYTD, SUM(isnull(b.groupTicketAmt,0) + isnull(b.publicTicketAmt,0)+ isnull(b.studentAmt,0)) as actualYTD 
