...
--exec rptCustSeasonTicketFootballRenew2_2014Build


CREATE   PROCEDURE [dbo].[rptCustSeasonTicketFootballRenew2_2014ProdReportBaseTest] 
...
select 
      ...
      ,case when TIPRICELEVELMAP2.PL_CLASS IS Null then 'NOT CLASSIFIED'
       		when TIPRICELEVELMAP2.PL_CLASS = '$1399/$1459/$1499 Level' then '$1459/$1499/$1575'
            when TIPRICELEVELMAP2.PL_CLASS = '$159/$179/$199 Level' then '$179/$189/$199'
            when TIPRICELEVELMAP2.PL_CLASS = '$1859/$1929/$1999 Level' then '$1929/$1999/$2099'
            when TIPRICELEVELMAP2.PL_CLASS = '$249/$279/$335 Level' then '$279/$289/$299'
            when TIPRICELEVELMAP2.PL_CLASS = '$499/$559/$625 Level' then '$524/$544/$564'
            when TIPRICELEVELMAP2.PL_CLASS = '$875/$885/$899 Level' then '$899/$919/$939'
            when TIPRICELEVELMAP2.PL_CLASS = '$120 Level' then '$120'
...
where rb.ITEM = 'FS' AND E_PL not in ('10')  AND rb.SEASON in (@curSeason, @prevSeason)
