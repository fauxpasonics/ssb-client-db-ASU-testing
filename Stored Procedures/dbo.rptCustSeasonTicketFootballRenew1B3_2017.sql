...
CREATE  PROCEDURE [dbo].[rptCustSeasonTicketFootballRenew1B3_2017] 
...
where drive_year IN (@prevSeason)  AND fund_name = '17FBPS'
)
...
select SUM(donation_paid_amount)  from #DonationBase  
where drive_year IN (@prevSeason)  AND fund_name = '17FBMFCL'
...
select SUM(donation_paid_amount)  from #DonationBase  
where drive_year IN (@prevSeason)  AND fund_name = '17FBDSTE'
...
select SUM(donation_paid_amount)  from #DonationBase 
where drive_year IN (@prevSeason)  AND fund_name = '17FBLGCL'
...
select SUM(donation_paid_amount)  from #DonationBase 
where drive_year IN (@prevSeason)  AND fund_name = '17FBNTCL'
...
select SUM(donation_paid_amount)  from #DonationBase  
where drive_year IN (@curSeason)  AND fund_name = '17FBPS'
...
select SUM(donation_paid_amount)  from #DonationBase 
where drive_year IN (@curSeason)  AND fund_name = '17FBDSTE'
...
select SUM(donation_paid_amount)  from #DonationBase  
where drive_year IN (@curSeason)  AND fund_name = '17FBLGCL'
...
select SUM(donation_paid_amount)  from #DonationBase  
where drive_year IN (@curSeason)  AND fund_name = '17FBNTCL'
