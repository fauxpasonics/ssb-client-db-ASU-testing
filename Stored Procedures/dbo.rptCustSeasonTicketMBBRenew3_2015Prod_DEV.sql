...
CREATE PROCEDURE [dbo].[rptCustSeasonTicketMBBRenew3_2015Prod_DEV] 
    (
      @startDate DATE
    , @endDate DATE
...
select 'MB01','13200','600'  union all 
select 'MB02','9900','450'   union all 
select 'MB03','9900','450'   union all 
select 'MB04','9900','450'   union all 
select 'MB05','37500','1500'   union all 
select 'MB06','17600','800'  union all 
select 'MB07','17600','800'  union all
select 'MB08','17600','800'  union all 
select 'MB09','150000','2500'   union all 
select 'MB10','25000','1000'   union all 
select 'MB11','25000','1000'   union all 
select 'MB12','30000','1200'   union all 
select 'MB13','25000','1000'  union all 
select 'MB14','30000','1200'  union all
select 'MB15','31250','1250' union all 
select 'MB16','13200','600'   union all 
select 'MB17','37350','1500' 
