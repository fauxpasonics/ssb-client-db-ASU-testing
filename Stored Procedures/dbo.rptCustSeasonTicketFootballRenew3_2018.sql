...
-- Reviewed By: 
-- Reviewed Date: 
-- Description: ASU Football HOB Single Game Section
-- =============================================
...
CREATE PROCEDURE [dbo].[rptCustSeasonTicketFootballRenew3_2018] 
    (
      @startDate DATE
    , @endDate DATE
...
(EventCode)
select '18FBF01'  union all 
select '18FBF02'  union all 
select '18FBF03'  union all 
select '18FBF04'  union all 
select '18FBF05'  union all 
select '18FBF06'  union all
select '18FBF07'
...
Select '18FBF01',0,0  UNION ALL
Select '18FBF02',0,0 UNION ALL
Select '18FBF03',0,0  UNION ALL
Select '18FBF04',0,0  UNION ALL
Select '18FBF05',0,0  UNION ALL
Select '18FBF06',0,0  UNION ALL
Select '18FBF07',0,0
