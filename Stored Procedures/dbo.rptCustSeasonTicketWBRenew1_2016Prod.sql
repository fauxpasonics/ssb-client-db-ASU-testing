...
CREATE PROCEDURE [dbo].[rptCustSeasonTicketWBRenew1_2016Prod] 
    (
      @startDate DATE
    , @endDate DATE
...
SELECT 'Mini Plans FSE', '3000'  UNION ALL
SELECT 'Season', '66000'  UNION ALL
SELECT 'Single Game Tickets',   '60000'
