...
CREATE PROCEDURE [dbo].[rpt_TurnKey_DataExtract_WB15_WB16]
AS
    BEGIN
...
-- Create #SalesBase --------------------------------------------------------------------------------------------------
        ...
        INSERT  INTO #SalesBase
                ...
                WHERE   1 = 1
                        AND tkTransItemEvent.SEASON IN ( 'WB16', 'WB15' )
                        ...
                        AND ( tkTrans.E_STAT NOT IN ( 'MI', 'MO', 'TO', 'TI',
						 ...
						 AND tkTransItem.Item <> 'NCAA' --remove NCAA
						 AND tkTransItem.Item NOT LIKE 'S%' --remove NCAA
...
/******************************************* Output *********************************************************************************/
        ...
        SELECT  sb.SEASON
              ...
              INTO dbo.TI_TurnKey_DataExtract_WB16_WB17
        FROM    #SalesBase sb
