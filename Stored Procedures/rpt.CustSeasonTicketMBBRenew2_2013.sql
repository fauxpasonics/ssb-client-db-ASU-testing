...
--exec rptCustSeasonTicketMBBRenew2_2013

CREATE   PROCEDURE [rpt].[CustSeasonTicketMBBRenew2_2013] 
...
select 
      ...
      , CASE WHEN rb.I_PT like 'N%' THEN 0 WHEN rb.I_PT like 'BN%' then 0  WHEN rb.I_PT LIKE '%A' THEN 0 
...
where rb.ITEM = 'BS' AND rb.SEASON in (@curSeason)
	AND ( PAIDTOTAL > 0 OR CUSTOMER in ('152760','164043','186078' ) OR rb.I_PT = 'BNYALC' )
		AND CUSTOMER <> '137398'
