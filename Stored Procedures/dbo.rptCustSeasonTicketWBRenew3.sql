...
/***************************************************************************************/
/***************************************************************************************/
CREATE PROCEDURE [dbo].[rptCustSeasonTicketWBRenew3] 
    (
      @startDate DATE
    , @endDate DATE
...
(eventcode)
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB01')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB02')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB03')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB04')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB05')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB06')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB07')  UNION ALL
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB08')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB09')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB10')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB11')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB12')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB13')  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB14')  UNION ALL
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB15')  UNION ALL
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB16')
...
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB01')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB02')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB03')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB04')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB05')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB06')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB07')	,'0'	,'0'  UNION ALL
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB08')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB09')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB10')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB11')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB12')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB13')	,'0'	,'0'  UNION ALL 
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB14')	,'0'	,'0'  UNION ALL
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB15')	,'0'	,'0'  UNION ALL
SELECT CONCAT(RIGHT(@curSeason,2),'WBWB16')	,'0'	,'0'
