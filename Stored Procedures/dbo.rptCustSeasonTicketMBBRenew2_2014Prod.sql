...
--exec rptCustSeasonTicketMBBRenew2_2014Prod


CREATE   PROCEDURE [dbo].[rptCustSeasonTicketMBBRenew2_2014Prod] 
...
where rb.ITEM = 'BS'  AND rb.SEASON in (@curSeason, @prevSeason)
