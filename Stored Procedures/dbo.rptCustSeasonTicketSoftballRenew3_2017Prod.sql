...
CREATE  PROCEDURE [dbo].[rptCustSeasonTicketSoftballRenew3_2017Prod] 
(
  @startDate DATE
, @endDate DATE
...
select	'SB01'	,5000      ,0  	union all
select	'SB02'	,18500      ,0  	union all
select	'SB03'	,18500      ,0  	union ALL
select	'SB04'	,8000      ,0  	union all
select	'SB23'	,4000      ,0  	union all
select	'SB24'	,6000      ,0  	union all
select	'SB25'	,3000      ,0  	union all
select	'SB05'	,2000      ,0  	union all
select	'SB06'	,1000      ,0  	union all
select	'SB07'	,8000      ,0  	union all
select	'SB08'	,9000      ,0  	union all
select	'SB09'	,8000      ,0  	union all
select	'SB10'	,2500      ,0  	union all
select	'SB11'	,4000      ,0  	union all
select	'SB12'	,5000      ,0  	union all
select	'SB13'	,3000      ,0  	union all
select	'SB14'	,6000      ,0  	union all
select	'SB15'	,6000      ,0  	union all
select	'SB16'	,5000      ,0  	union all
select	'SB17'	,5500      ,0  	union all
select	'SB18'	,7000      ,0  	union all
select	'SB19'	,4000      ,0  	union all
select	'SB20'	,9000      ,0  	union all
select	'SB21'	,11000      ,0  	union all
select	'SB22'	,10000      ,0  	
...
FROM ( SELECT tkSeatSeat.season
       ...
       WHERE tkSeatSeat.STAT<> '-'
			...
			AND tkSeatSeat.STAT<>  'v'
			 ...
			 AND tkSeatSeat.SEASON IN (@curseason)
