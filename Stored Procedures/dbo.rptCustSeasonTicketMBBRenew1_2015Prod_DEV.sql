...
--exec rptCustSeasonTicketMBBRenew1_2015Prod


CREATE  PROCEDURE [dbo].[rptCustSeasonTicketMBBRenew1_2015Prod_DEV] 
    (
      @startDate DATE
    , @endDate DATE
...
Select 'Mini Plans FSE', '175000'  UNION ALL
Select 'Season', '500000' UNION ALL
Select 'Single Game Tickets', '500000'   
