...
CREATE PROCEDURE [dbo].[rptCustSeasonTicketMBBRenew3_2018] 
    (
      @startDate DATE
    , @endDate DATE
...
GROUP BY  SeasonYear 
 ...
 ,IsComp
	...
	select '18MBB01' union all 
	select '18MBB02' union all 
	select '18MBB03' union all 
	select '18MBB04' union all 
	select '18MBB05' union all 
	select '18MBB06' union all 
	select '18MBB07' union all
	select '18MBB08' union all 
	select '18MBB09' union all 
	select '18MBB10' union all 
	select '18MBB11' union all 
	select '18MBB12' union all 
	select '18MBB13' union all 
	select '18MBB14' union all
	select '18MBB15' union all 
	select '18MBB16' union all 
	select '18MBB17'   
	...
	select '18MBB01','0','0'  union all -- Update these values when ASU can provide them
	select '18MBB02','0','0'   union all 
	select '18MBB03','0','0'   union all 
	select '18MBB04','0','0'   union all 
	select '18MBB05','0','0'   union all 
	select '18MBB06','0','0'   union all 
	select '18MBB07','0','0'   union all 
	select '18MBB08','0','0'   union all  
	select '18MBB09','0','0'   union all 
	select '18MBB10','0','0'   union all  
	select '18MBB11','0','0'   union all  
	select '18MBB12','0','0'   union all 
	select '18MBB13','0','0'   union all  
	select '18MBB14','0','0'   union all 
	select '18MBB15','0','0'   union all 
	select '18MBB16','0','0'   union all 
	select '18MBB17','0','0'	
