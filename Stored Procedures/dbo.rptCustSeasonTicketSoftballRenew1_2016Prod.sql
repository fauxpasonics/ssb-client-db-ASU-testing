...
CREATE PROCEDURE [dbo].[rptCustSeasonTicketSoftballRenew1_2016Prod] 
(
  @startDate DATE
, @endDate DATE
...
SELECT 'Season',				'88000'	UNION ALL
SELECT 'Mini Plans FSE',			'15000'	UNION ALL
SELECT 'All Session Passes',	'30000'	UNION ALL
SELECT 'Single Game Tickets',			'167000'
