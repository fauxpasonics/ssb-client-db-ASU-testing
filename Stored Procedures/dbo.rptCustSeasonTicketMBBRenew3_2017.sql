...
CREATE PROCEDURE [dbo].[rptCustSeasonTicketMBBRenew3_2017] 
    (
      @startDate DATE
    , @endDate DATE
...
GROUP BY  SeasonYear 
 ...
 ,IsComp
	...
	select '17MBB01' union all 
	select '17MBB02' union all 
	select '17MBB03' union all 
	select '17MBB04' union all 
	select '17MBB05' union all 
	select '17MBB06' union all 
	select '17MBB07' union all
	select '17MBB08' union all 
	select '17MBB09' union all 
	select '17MBB10' union all 
	select '17MBB11' union all 
	select '17MBB12' union all 
	select '17MBB13' union all 
	select '17MBB14' union all
	select '17MBB15' union all 
	select '17MBB16' union all 
	select '17MBB17'   
	...
	select '17MBB01','5250','350'  union all 
	select '17MBB02','5250','350'   union all 
	select '17MBB03','3750','250'   union all 
	select '17MBB04','3750','250'   union all 
	select '17MBB05','25000','1750'   union all 
	select '17MBB06','50000','2000'   union all 
	select '17MBB07','8800','600'   union all 
	select '17MBB08','12000','750'   union all  
	select '17MBB09','28000','1000'   union all 
	select '17MBB10','27000','1400'   union all  
	select '17MBB11','28000','1000'   union all  
	select '17MBB12','27000','1500'   union all 
	select '17MBB13','25000','750'   union all  
	select '17MBB14','65000','2500'   union all 
	select '17MBB15','160000','3200'   union all 
	select '17MBB16','27000','1150'   union all 
	select '17MBB17','29000','1200'	
	...
	where fts.SeasonYear =  @curSeason
		...
		AND fts.EventCode <> '17MBB18' --excluding event that should be deleted
