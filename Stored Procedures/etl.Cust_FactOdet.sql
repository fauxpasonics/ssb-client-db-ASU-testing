...
OR (di.ItemCode = 'FSC' AND SeasonCode = 'F14')
...
OR ItemCode IN ('FCG', 'PAC12', 'SUN', 'CB', 'NCAA', 'FF', 'RB', 'NIT1', 'NIT3', 'P10', 'NCAA1', 'KFHB', 'IB', 'BCS', 'BOWL', 'LB', 'BWW', 'CHAMP', 'HB')
OR Itemcode LIKE 'P[1-6]'
