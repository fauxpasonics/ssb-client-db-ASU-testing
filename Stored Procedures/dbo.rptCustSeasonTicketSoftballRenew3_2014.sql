...
CREATE   PROCEDURE [dbo].[rptCustSeasonTicketSoftballRenew3_2014] 
...
select 'SB29'  union all
select 'SB30'  union all
select 'SB31'  union all
select 'SB32' 
...
select 'SB01',2412,268  union all 
select 'SB02',5481,609 union all 
select 'SB03',9000,1000  union all 
select 'SB04',5400,600  union all 
select 'SB05',1350,150  union all 
select 'SB06',5400,600  union all 
select 'SB07',3600,400  union all
select 'SB08',1800,200  union all 
select 'SB09',1350,150 union all 
select 'SB10',2700,300  union all 
select 'SB11',4320,480 union all 
select 'SB12',2610,290  union all 
select 'SB13',2700,300  union all 
select 'SB14',2475,275  union all
select 'SB15',3150,350  union all
select 'SB16',3600,400  union all
select 'SB17',1350,150  union all
select 'SB18',13200,1200  union all
select 'SB19',6600,600  union all
select 'SB20',8250,750  union all
select 'SB21',14850,1350  union all
select 'SB22',14850,1350  union all
select 'SB23',7150,650  union all
select 'SB24',4950,550  union all
select 'SB25',6750,750  union all
select 'SB26',4050,450  union all
select 'SB27',2700,300  union all
select 'SB28',4050,450  union all
select 'SB29',2700,300  union all
select 'SB30',8800,800  union all
select 'SB31',11000,1000  union all
select 'SB32',13177,1197   
