...
CREATE  PROCEDURE [dbo].[rptCustSeasonTicketSoftballRenew3_2018Prod] 
(
  @startDate DATE
, @endDate DATE
...
(eventcode)
select '18SBSB01'  union all 
select '18SBSB02'  union all 
select '18SBSB03'  union all 
select '18SBSB04'  union all 
select '18SBSB05'  union all 
select '18SBSB06'  union all 
select '18SBSB07'  union all
select '18SBSB08'  union all 
select '18SBSB09'  union all 
select '18SBSB11'  union all 
select '18SBSB12'  union all 
select '18SBSB13'  union all 
select '18SBSB14'  union all
select '18SBSB16'  union all
select '18SBSB17'  union all
select '18SBSB18'  union all
select '18SBSB19'  union all
select '18SBSB20'  union all
select '18SBSB21'  union all
select '18SBSB23'  union all
select '18SBSB24'  union all
select '18SBSB25'  union all
select '18SBSB26'  union all
select '18SBSB27'  union all
select '18SBSB28'  union all
select '18SBSB29'  union all
select '18SBSB30'  union all
select '18SBSB31'  
...
select	'18SBSB01'	,6000      ,540  	union all
select	'18SBSB02'	,9000      ,820  	union all
select	'18SBSB03'	,10000     ,910  	union ALL
select	'18SBSB04'	,5000      ,455  	union all
select	'18SBSB05'	,3000      ,270  	union all
select	'18SBSB06'	,4000      ,365  	union all
select	'18SBSB07'	,3000      ,270  	union all
select	'18SBSB08'	,5000      ,455  	union all
select	'18SBSB09'	,4000      ,365  	union all
select	'18SBSB11'	,4000      ,370  	union all
select	'18SBSB12'	,4000     ,370  	union all
select	'18SBSB13'	,6000      ,550  	union all
select	'18SBSB14'	,6000      ,550  	union all
select	'18SBSB16'	,6000      ,550  	union all
select	'18SBSB17'	,6000      ,550  	union all
select	'18SBSB18'	,5000      ,460  	union all
select	'18SBSB19'	,5000      ,460  	union all
select	'18SBSB20'	,6000      ,550  	union all
select	'18SBSB21'	,6000      ,550  	union all
select	'18SBSB23'	,10000      ,770  	union all
select	'18SBSB24'	,11000     ,850   	union all
select	'18SBSB25'	,9000      ,700  	union all
select	'18SBSB26'	,10000      ,770  	union all
select	'18SBSB27'	,11000      ,850  	union all
select	'18SBSB28'	,9000      ,700  	union all
select	'18SBSB29'	,6000      ,550  	union all
select	'18SBSB30'	,6000      ,550  	union all
select	'18SBSB31'	,5000      ,550  	
