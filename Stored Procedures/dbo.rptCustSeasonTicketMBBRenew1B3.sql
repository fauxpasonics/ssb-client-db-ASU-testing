...
*****/
/*************************************************************************************/
CREATE PROCEDURE [dbo].[rptCustSeasonTicketMBBRenew1B3](
...
--DECLARE @prevSeason NVARCHAR(50)
--DECLARE @curSeason NVARCHAR(50)
--SET @prevSeason = '2017'
--SET @curSeason = '2018'
SET @Sport = 'MBB'
...
where drive_year IN (@curSeason)  AND fund_name = CONCAT(RIGHT(@curSeason,2),'BBPS')
)
