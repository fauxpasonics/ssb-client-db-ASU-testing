...
CREATE PROCEDURE [dbo].[rptCustSeasonTicketSoftballRenew4_2017Prod] 
...
DECLARE @curSeason VARCHAR(50) = 'SB17'
...
VALUES
('Kajikawa Classic','2017-02-09', '2017-02-12')
,('Littlewood', '2017-02-17', '2017-02-20')
--,('Diamond Devil', '2016-02-26', '2016-02-28')
--,('Louisville Slugger', '2017-03-10', '2017-03-12')
...
SELECT
       ...
       ,'2017-02-17' as StartDate
       ,'2017-02-19' as EndDate
       ,SUM(ORDQTY)
       ,SUM(ORDTOTAL)
FROM #ReportBase ReportBase
