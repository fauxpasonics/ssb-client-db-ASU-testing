...
CREATE PROCEDURE [etl].[Advance_Load_DimCustomer]
...
SELECT * 
INTO #tmpETL 
FROM [etl].[vw_Advance_Load_DimCustomer]
...
THEN UPDATE SET 
	...
	, mytarget.[customer_matchkey] = mysource.[match_key]
...
(
		SourceDB, SourceSystem, SourceSystemPriority, SSID, NameDirtyHash, NameIsCleanStatus, FullName, FirstName, MiddleName, LastName 
    ...
    VALUES (
		...
		*/
		...
		, mySource.FullName
		--, mySource.Prefix
		, mySource.FirstName --added to account for name issues 8/31/16 AC
		, mySource.MiddleName
		, mySource.LastName
		--, mySource.Suffix
		--, mySource.Title
