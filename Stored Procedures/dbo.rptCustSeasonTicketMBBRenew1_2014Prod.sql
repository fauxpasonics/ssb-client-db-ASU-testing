...
--exec rptCustSeasonTicketMBBRenew1_2014Prod


CREATE         PROCEDURE [dbo].[rptCustSeasonTicketMBBRenew1_2014Prod] 
...
Select 'Mini Plans FSE', '150000'  UNION ALL
Select 'Season', '365000' UNION ALL
Select 'Single Game Tickets', '600000'   
