...
SELECT * FROM [ods].[AsOf_TM_CustomerUpdate_PostObjects] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_TM_CustomerUpdate_PostObjects] (@AsOfDate DATETIME)

RETURNS @Results TABLE
(
[multi_query_value_for_audit] [nvarchar](100) NULL,
[AccountId] [int] NULL,
[Errors_ApiSqlCode] [nvarchar](max) NULL,
[Errors_BeforeUpdate] [nvarchar](max) NULL,
[acct_id] [int] NULL,
...
FROM
	...
	FROM [ods].[Snapshot_TM_CustomerUpdate_PostObjects]
	) a
WHERE
