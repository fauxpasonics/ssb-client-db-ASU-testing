...
SELECT * FROM [ods].[AsOf_TM_CustomerUpdate_After] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_TM_CustomerUpdate_After] (@AsOfDate DATETIME)
...
FROM
	...
	FROM [ods].[Snapshot_TM_CustomerUpdate_After]
	) a
WHERE
