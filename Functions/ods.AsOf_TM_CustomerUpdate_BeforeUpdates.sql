...
SELECT * FROM [ods].[AsOf_TM_CustomerUpdate_BeforeUpdates] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_TM_CustomerUpdate_BeforeUpdates] (@AsOfDate DATETIME)

RETURNS @Results TABLE
(
[multi_query_value_for_audit] [nvarchar](100) NULL,
[AccountId] [int] NULL,
[Errors_ApiSqlCode] [nvarchar](25) NULL,
[Errors_BeforeUpdate] [nvarchar](25) NULL,
[acct_id] [int] NULL,
...
FROM
	...
	FROM [ods].[Snapshot_TM_CustomerUpdate_BeforeUpdates]
	) a
WHERE
