CREATE TABLE [etl].[tmp_load_02440C01165847A2B93AA00B2DD16E4E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_02440C01165847A2B93AA00B2DD16E4E_ss] ON [etl].[tmp_load_02440C01165847A2B93AA00B2DD16E4E] ([SourceSystem], [SSID])
GO
