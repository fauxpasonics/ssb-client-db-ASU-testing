CREATE TABLE [bkp].[dbo__PD_PATRON_20170207]
(
...
GO
ALTER TABLE [bkp].[dbo__PD_PATRON_20170207] ADD CONSTRAINT [PK_PD_PATRON_d97071b1-e068-4b26-9bb5-56ff2c31b5c2] PRIMARY KEY CLUSTERED  ([ETLSID], [PATRON])
GO
CREATE NONCLUSTERED INDEX [IDX_PATRON] ON [bkp].[dbo__PD_PATRON_20170207] ([PATRON])
GO
