CREATE TABLE [etl].[tmp_load_359991F0D2DB49EAAE589EFC791FE4AB]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_359991F0D2DB49EAAE589EFC791FE4AB_ss] ON [etl].[tmp_load_359991F0D2DB49EAAE589EFC791FE4AB] ([SourceSystem], [SSID])
GO
