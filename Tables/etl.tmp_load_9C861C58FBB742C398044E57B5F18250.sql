CREATE TABLE [etl].[tmp_load_9C861C58FBB742C398044E57B5F18250]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_9C861C58FBB742C398044E57B5F18250_ss] ON [etl].[tmp_load_9C861C58FBB742C398044E57B5F18250] ([SourceSystem], [SSID])
GO
