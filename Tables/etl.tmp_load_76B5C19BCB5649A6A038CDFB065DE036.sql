CREATE TABLE [etl].[tmp_load_76B5C19BCB5649A6A038CDFB065DE036]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_76B5C19BCB5649A6A038CDFB065DE036_ss] ON [etl].[tmp_load_76B5C19BCB5649A6A038CDFB065DE036] ([SourceSystem], [SSID])
GO
