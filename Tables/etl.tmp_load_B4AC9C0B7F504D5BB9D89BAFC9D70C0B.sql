CREATE TABLE [etl].[tmp_load_B4AC9C0B7F504D5BB9D89BAFC9D70C0B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_B4AC9C0B7F504D5BB9D89BAFC9D70C0B_ss] ON [etl].[tmp_load_B4AC9C0B7F504D5BB9D89BAFC9D70C0B] ([SourceSystem], [SSID])
GO
