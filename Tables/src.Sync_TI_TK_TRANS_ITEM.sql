CREATE TABLE [src].[Sync_TI_TK_TRANS_ITEM]
(
...
GO
ALTER TABLE [src].[Sync_TI_TK_TRANS_ITEM] ADD CONSTRAINT [PK__Sync_TI___19364FD2EC65EA5C] PRIMARY KEY CLUSTERED  ([ETL_Sync_Id])
GO
