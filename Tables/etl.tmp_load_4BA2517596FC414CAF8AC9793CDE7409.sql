CREATE TABLE [etl].[tmp_load_4BA2517596FC414CAF8AC9793CDE7409]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4BA2517596FC414CAF8AC9793CDE7409_ss] ON [etl].[tmp_load_4BA2517596FC414CAF8AC9793CDE7409] ([SourceSystem], [SSID])
GO
