CREATE TABLE [etl].[tmp_load_E0913DF784DC432DAA4D1CBBC77AF19E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_E0913DF784DC432DAA4D1CBBC77AF19E_ss] ON [etl].[tmp_load_E0913DF784DC432DAA4D1CBBC77AF19E] ([SourceSystem], [SSID])
GO
