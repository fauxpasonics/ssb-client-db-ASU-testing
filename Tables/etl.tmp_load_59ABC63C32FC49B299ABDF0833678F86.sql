CREATE TABLE [etl].[tmp_load_59ABC63C32FC49B299ABDF0833678F86]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_59ABC63C32FC49B299ABDF0833678F86_ss] ON [etl].[tmp_load_59ABC63C32FC49B299ABDF0833678F86] ([SourceSystem], [SSID])
GO
