CREATE TABLE [dbo].[TK_TRANS_ITEM_OLD]
(
...
GO
ALTER TABLE [dbo].[TK_TRANS_ITEM_OLD] ADD CONSTRAINT [PK_TK_TRANS_ITEM_OLd] PRIMARY KEY CLUSTERED  ([ETLSID], [SEASON], [TRANS_NO], [VMC])
GO
CREATE NONCLUSTERED INDEX [IDX_CUSTOMER] ON [dbo].[TK_TRANS_ITEM_OLD] ([CUSTOMER])
GO
CREATE NONCLUSTERED INDEX [IDX_DATE] ON [dbo].[TK_TRANS_ITEM_OLD] ([DATE])
GO
CREATE NONCLUSTERED INDEX [IDX_I_PT] ON [dbo].[TK_TRANS_ITEM_OLD] ([I_PT])
GO
CREATE NONCLUSTERED INDEX [IDX_ITEM] ON [dbo].[TK_TRANS_ITEM_OLD] ([ITEM])
GO
CREATE NONCLUSTERED INDEX [IDX_SALECODE] ON [dbo].[TK_TRANS_ITEM_OLD] ([SALECODE])
GO
CREATE NONCLUSTERED INDEX [IDX_SEASON] ON [dbo].[TK_TRANS_ITEM_OLD] ([SEASON])
GO
CREATE NONCLUSTERED INDEX [IDX_TRANS_NO] ON [dbo].[TK_TRANS_ITEM_OLD] ([TRANS_NO])
GO
CREATE NONCLUSTERED INDEX [IDX_VMC] ON [dbo].[TK_TRANS_ITEM_OLD] ([VMC])
GO
CREATE NONCLUSTERED INDEX [IDX_ZID] ON [dbo].[TK_TRANS_ITEM_OLD] ([ZID])
GO
