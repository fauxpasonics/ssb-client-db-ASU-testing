CREATE TABLE [etl].[tmp_load_CCACEDAC1C484A19B847878C37E75B7B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_CCACEDAC1C484A19B847878C37E75B7B_ss] ON [etl].[tmp_load_CCACEDAC1C484A19B847878C37E75B7B] ([SourceSystem], [SSID])
GO
