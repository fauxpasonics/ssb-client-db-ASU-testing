CREATE TABLE [etl].[tmp_load_3E496853D118434BB7CCCE9BDF729ACF]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_3E496853D118434BB7CCCE9BDF729ACF_ss] ON [etl].[tmp_load_3E496853D118434BB7CCCE9BDF729ACF] ([SourceSystem], [SSID])
GO
