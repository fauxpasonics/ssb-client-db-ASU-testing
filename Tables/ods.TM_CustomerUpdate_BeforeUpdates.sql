CREATE TABLE [ods].[TM_CustomerUpdate_BeforeUpdates]
(
...
[ETL_CreatedOn] [datetime] NOT NULL CONSTRAINT [DF__TM_Custom__ETL_C__2A42EE06] DEFAULT ([etl].[ConvertToLocalTime](CONVERT([datetime2](0),getdate(),(0)))),
[ETL_CreatedBy] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__TM_Custom__ETL_C__2B37123F] DEFAULT (suser_sname()),
[ETL_UpdatedOn] [datetime] NOT NULL CONSTRAINT [DF__TM_Custom__ETL_U__2C2B3678] DEFAULT ([etl].[ConvertToLocalTime](CONVERT([datetime2](0),getdate(),(0)))),
[ETL_UpdatedBy] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__TM_Custom__ETL_U__2D1F5AB1] DEFAULT (suser_sname())
)
GO
...
----------- CREATE TRIGGER -----------
CREATE TRIGGER [ods].[Snapshot_TM_CustomerUpdate_BeforeUpdatesUpdate] ON [ods].[TM_CustomerUpdate_BeforeUpdates]
AFTER UPDATE, DELETE
