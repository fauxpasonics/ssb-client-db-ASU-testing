CREATE TABLE [etl].[tmp_load_469B230289704865A5B59E7C56B4BA1F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_469B230289704865A5B59E7C56B4BA1F_ss] ON [etl].[tmp_load_469B230289704865A5B59E7C56B4BA1F] ([SourceSystem], [SSID])
GO
