CREATE TABLE [etl].[tmp_load_D2743A757A1D45B28AD0F4B6FD8CA7FC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D2743A757A1D45B28AD0F4B6FD8CA7FC_ss] ON [etl].[tmp_load_D2743A757A1D45B28AD0F4B6FD8CA7FC] ([SourceSystem], [SSID])
GO
