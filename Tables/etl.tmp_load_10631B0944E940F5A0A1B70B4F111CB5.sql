CREATE TABLE [etl].[tmp_load_10631B0944E940F5A0A1B70B4F111CB5]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_10631B0944E940F5A0A1B70B4F111CB5_ss] ON [etl].[tmp_load_10631B0944E940F5A0A1B70B4F111CB5] ([SourceSystem], [SSID])
GO
