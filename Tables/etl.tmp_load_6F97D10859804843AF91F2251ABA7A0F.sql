CREATE TABLE [etl].[tmp_load_6F97D10859804843AF91F2251ABA7A0F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6F97D10859804843AF91F2251ABA7A0F_ss] ON [etl].[tmp_load_6F97D10859804843AF91F2251ABA7A0F] ([SourceSystem], [SSID])
GO
