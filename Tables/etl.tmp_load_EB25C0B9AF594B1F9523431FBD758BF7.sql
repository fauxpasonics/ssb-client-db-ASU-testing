CREATE TABLE [etl].[tmp_load_EB25C0B9AF594B1F9523431FBD758BF7]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_EB25C0B9AF594B1F9523431FBD758BF7_ss] ON [etl].[tmp_load_EB25C0B9AF594B1F9523431FBD758BF7] ([SourceSystem], [SSID])
GO
