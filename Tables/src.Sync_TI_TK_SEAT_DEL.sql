CREATE TABLE [src].[Sync_TI_TK_SEAT_DEL]
(
...
GO
ALTER TABLE [src].[Sync_TI_TK_SEAT_DEL] ADD CONSTRAINT [PK__Sync_TI___19364FD24199F8C5] PRIMARY KEY CLUSTERED  ([ETL_Sync_Id])
GO
