CREATE TABLE [etl].[tmp_load_8941D08D0DEF4AFCA107963B9BDB9BAD]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_8941D08D0DEF4AFCA107963B9BDB9BAD_ss] ON [etl].[tmp_load_8941D08D0DEF4AFCA107963B9BDB9BAD] ([SourceSystem], [SSID])
GO
