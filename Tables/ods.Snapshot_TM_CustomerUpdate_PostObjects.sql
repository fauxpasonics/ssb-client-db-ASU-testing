CREATE TABLE [ods].[Snapshot_TM_CustomerUpdate_PostObjects]
(
[TM_CustomerUpdate_PostObjectsSK] [int] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [ods].[Snapshot_TM_CustomerUpdate_PostObjects] ADD CONSTRAINT [PK__Snapshot__EDD8F0099C927DF3] PRIMARY KEY CLUSTERED  ([TM_CustomerUpdate_PostObjectsSK])
GO
