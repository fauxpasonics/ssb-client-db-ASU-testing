CREATE TABLE [etl].[tmp_load_D412CDF5802345FC8F0A25150F7D12A2]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D412CDF5802345FC8F0A25150F7D12A2_ss] ON [etl].[tmp_load_D412CDF5802345FC8F0A25150F7D12A2] ([SourceSystem], [SSID])
GO
