CREATE TABLE [etl].[tmp_load_1BA4ABAB03B24D889C2E671833ECAE79]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1BA4ABAB03B24D889C2E671833ECAE79_ss] ON [etl].[tmp_load_1BA4ABAB03B24D889C2E671833ECAE79] ([SourceSystem], [SSID])
GO
