CREATE TABLE [etl].[tmp_load_79A2B4EC2FA64C468E29B0FE1D38FC5C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_79A2B4EC2FA64C468E29B0FE1D38FC5C_ss] ON [etl].[tmp_load_79A2B4EC2FA64C468E29B0FE1D38FC5C] ([SourceSystem], [SSID])
GO
