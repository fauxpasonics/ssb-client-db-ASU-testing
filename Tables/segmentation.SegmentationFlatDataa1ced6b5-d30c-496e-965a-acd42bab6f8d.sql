CREATE TABLE [segmentation].[SegmentationFlatDataa1ced6b5-d30c-496e-965a-acd42bab6f8d]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDataa1ced6b5-d30c-496e-965a-acd42bab6f8d] ADD CONSTRAINT [pk_SegmentationFlatDataa1ced6b5-d30c-496e-965a-acd42bab6f8d] PRIMARY KEY NONCLUSTERED  ([id])
GO
