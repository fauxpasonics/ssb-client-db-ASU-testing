CREATE TABLE [etl].[tmp_load_F85C5EB1A89C4206A91508AD1B1F6666]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F85C5EB1A89C4206A91508AD1B1F6666_ss] ON [etl].[tmp_load_F85C5EB1A89C4206A91508AD1B1F6666] ([SourceSystem], [SSID])
GO
