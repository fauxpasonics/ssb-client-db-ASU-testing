CREATE TABLE [etl].[tmp_load_6FF88E4E124646739C28BF9A5510618F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6FF88E4E124646739C28BF9A5510618F_ss] ON [etl].[tmp_load_6FF88E4E124646739C28BF9A5510618F] ([SourceSystem], [SSID])
GO
