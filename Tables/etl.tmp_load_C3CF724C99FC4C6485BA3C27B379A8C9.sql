CREATE TABLE [etl].[tmp_load_C3CF724C99FC4C6485BA3C27B379A8C9]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C3CF724C99FC4C6485BA3C27B379A8C9_ss] ON [etl].[tmp_load_C3CF724C99FC4C6485BA3C27B379A8C9] ([SourceSystem], [SSID])
GO
