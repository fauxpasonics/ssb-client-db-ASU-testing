CREATE TABLE [src].[Sync_TI_TK_CUSTOMER]
(
...
GO
ALTER TABLE [src].[Sync_TI_TK_CUSTOMER] ADD CONSTRAINT [PK__Sync_TI___19364FD264F5CCCD] PRIMARY KEY CLUSTERED  ([ETL_Sync_Id])
GO
