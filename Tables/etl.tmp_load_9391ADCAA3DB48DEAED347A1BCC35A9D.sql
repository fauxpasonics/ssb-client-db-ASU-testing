CREATE TABLE [etl].[tmp_load_9391ADCAA3DB48DEAED347A1BCC35A9D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_9391ADCAA3DB48DEAED347A1BCC35A9D_ss] ON [etl].[tmp_load_9391ADCAA3DB48DEAED347A1BCC35A9D] ([SourceSystem], [SSID])
GO
