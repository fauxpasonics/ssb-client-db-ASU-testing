CREATE TABLE [etl].[tmp_load_C92402662282400FBB5ABCEF0DA26A5B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C92402662282400FBB5ABCEF0DA26A5B_ss] ON [etl].[tmp_load_C92402662282400FBB5ABCEF0DA26A5B] ([SourceSystem], [SSID])
GO
