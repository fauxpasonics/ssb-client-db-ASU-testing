CREATE TABLE [etl].[tmp_load_ED8E945B9DBD45D5A3DC27854086C6C5]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_ED8E945B9DBD45D5A3DC27854086C6C5_ss] ON [etl].[tmp_load_ED8E945B9DBD45D5A3DC27854086C6C5] ([SourceSystem], [SSID])
GO
