CREATE TABLE [etl].[tmp_load_7DFCAC3DF2804024AD314C37C2301B23]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_7DFCAC3DF2804024AD314C37C2301B23_ss] ON [etl].[tmp_load_7DFCAC3DF2804024AD314C37C2301B23] ([SourceSystem], [SSID])
GO
