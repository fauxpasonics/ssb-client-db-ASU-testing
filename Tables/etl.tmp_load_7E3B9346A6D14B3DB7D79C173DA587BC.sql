CREATE TABLE [etl].[tmp_load_7E3B9346A6D14B3DB7D79C173DA587BC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_7E3B9346A6D14B3DB7D79C173DA587BC_ss] ON [etl].[tmp_load_7E3B9346A6D14B3DB7D79C173DA587BC] ([SourceSystem], [SSID])
GO
