CREATE TABLE [etl].[tmp_load_CFD1F63E687D4C72B5AD63FFB60B1A8B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_CFD1F63E687D4C72B5AD63FFB60B1A8B_ss] ON [etl].[tmp_load_CFD1F63E687D4C72B5AD63FFB60B1A8B] ([SourceSystem], [SSID])
GO
