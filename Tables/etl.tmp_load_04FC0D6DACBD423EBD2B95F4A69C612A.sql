CREATE TABLE [etl].[tmp_load_04FC0D6DACBD423EBD2B95F4A69C612A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_04FC0D6DACBD423EBD2B95F4A69C612A_ss] ON [etl].[tmp_load_04FC0D6DACBD423EBD2B95F4A69C612A] ([SourceSystem], [SSID])
GO
