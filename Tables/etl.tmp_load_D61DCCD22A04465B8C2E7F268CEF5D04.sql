CREATE TABLE [etl].[tmp_load_D61DCCD22A04465B8C2E7F268CEF5D04]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D61DCCD22A04465B8C2E7F268CEF5D04_ss] ON [etl].[tmp_load_D61DCCD22A04465B8C2E7F268CEF5D04] ([SourceSystem], [SSID])
GO
