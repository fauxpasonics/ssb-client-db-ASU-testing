CREATE TABLE [etl].[tmp_load_160BBAA13F7D4EA099C09D4CAF97552E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_160BBAA13F7D4EA099C09D4CAF97552E_ss] ON [etl].[tmp_load_160BBAA13F7D4EA099C09D4CAF97552E] ([SourceSystem], [SSID])
GO
