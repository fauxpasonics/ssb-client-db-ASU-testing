CREATE TABLE [etl].[tmp_load_86BDCD395BBD451DB6F0F0A589D655B8]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_86BDCD395BBD451DB6F0F0A589D655B8_ss] ON [etl].[tmp_load_86BDCD395BBD451DB6F0F0A589D655B8] ([SourceSystem], [SSID])
GO
