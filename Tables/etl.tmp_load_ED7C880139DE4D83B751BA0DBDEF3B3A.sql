CREATE TABLE [etl].[tmp_load_ED7C880139DE4D83B751BA0DBDEF3B3A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_ED7C880139DE4D83B751BA0DBDEF3B3A_ss] ON [etl].[tmp_load_ED7C880139DE4D83B751BA0DBDEF3B3A] ([SourceSystem], [SSID])
GO
