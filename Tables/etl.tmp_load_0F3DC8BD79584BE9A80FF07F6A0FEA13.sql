CREATE TABLE [etl].[tmp_load_0F3DC8BD79584BE9A80FF07F6A0FEA13]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_0F3DC8BD79584BE9A80FF07F6A0FEA13_ss] ON [etl].[tmp_load_0F3DC8BD79584BE9A80FF07F6A0FEA13] ([SourceSystem], [SSID])
GO
