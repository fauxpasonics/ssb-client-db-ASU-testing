CREATE TABLE [etl].[tmp_load_BAFF7467DB31412FBD7D72A3620963D9]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_BAFF7467DB31412FBD7D72A3620963D9_ss] ON [etl].[tmp_load_BAFF7467DB31412FBD7D72A3620963D9] ([SourceSystem], [SSID])
GO
