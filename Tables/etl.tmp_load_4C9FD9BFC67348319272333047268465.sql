CREATE TABLE [etl].[tmp_load_4C9FD9BFC67348319272333047268465]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4C9FD9BFC67348319272333047268465_ss] ON [etl].[tmp_load_4C9FD9BFC67348319272333047268465] ([SourceSystem], [SSID])
GO
