CREATE TABLE [etl].[tmp_load_9E03CEB91A28458C9EA28140147DF39C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_9E03CEB91A28458C9EA28140147DF39C_ss] ON [etl].[tmp_load_9E03CEB91A28458C9EA28140147DF39C] ([SourceSystem], [SSID])
GO
