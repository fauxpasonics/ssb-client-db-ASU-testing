CREATE TABLE [etl].[tmp_load_593B2FE0B247419480B4859F6E1F1A17]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_593B2FE0B247419480B4859F6E1F1A17_ss] ON [etl].[tmp_load_593B2FE0B247419480B4859F6E1F1A17] ([SourceSystem], [SSID])
GO
