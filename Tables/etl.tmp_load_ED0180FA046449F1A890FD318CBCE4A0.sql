CREATE TABLE [etl].[tmp_load_ED0180FA046449F1A890FD318CBCE4A0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_ED0180FA046449F1A890FD318CBCE4A0_ss] ON [etl].[tmp_load_ED0180FA046449F1A890FD318CBCE4A0] ([SourceSystem], [SSID])
GO
