CREATE TABLE [etl].[tmp_load_0D370AB0C35D48018F5C55F19D8E450F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_0D370AB0C35D48018F5C55F19D8E450F_ss] ON [etl].[tmp_load_0D370AB0C35D48018F5C55F19D8E450F] ([SourceSystem], [SSID])
GO
