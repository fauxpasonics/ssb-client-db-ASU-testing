...
[Question] [varchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Answer] [varchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [stg].[SFMC_Surveys] ADD CONSTRAINT [PK__SFMC_Sur__7EF6BFCDD84293B7] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
