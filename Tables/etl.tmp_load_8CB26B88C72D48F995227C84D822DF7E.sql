CREATE TABLE [etl].[tmp_load_8CB26B88C72D48F995227C84D822DF7E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_8CB26B88C72D48F995227C84D822DF7E_ss] ON [etl].[tmp_load_8CB26B88C72D48F995227C84D822DF7E] ([SourceSystem], [SSID])
GO
