CREATE TABLE [etl].[tmp_load_D406CE21984B4AAC924FF40CD5B67EBF]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D406CE21984B4AAC924FF40CD5B67EBF_ss] ON [etl].[tmp_load_D406CE21984B4AAC924FF40CD5B67EBF] ([SourceSystem], [SSID])
GO
