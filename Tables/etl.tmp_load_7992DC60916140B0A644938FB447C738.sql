CREATE TABLE [etl].[tmp_load_7992DC60916140B0A644938FB447C738]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_7992DC60916140B0A644938FB447C738_ss] ON [etl].[tmp_load_7992DC60916140B0A644938FB447C738] ([SourceSystem], [SSID])
GO
