...
GO
CREATE CLUSTERED INDEX [CIX_CleanDataOutput] ON [archive].[CleanDataOutput] ([BatchId], [ContactId], [SourceContactId]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CleanDataOutput_Input_Custom2_Included] ON [archive].[CleanDataOutput] ([Input_Custom2]) INCLUDE ([ETL_CreatedDate], [Input_SourceSystem], [SourceContactId]) WITH (DATA_COMPRESSION = PAGE)
GO
