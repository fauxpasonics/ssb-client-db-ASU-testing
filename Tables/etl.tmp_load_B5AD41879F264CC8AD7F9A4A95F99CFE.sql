CREATE TABLE [etl].[tmp_load_B5AD41879F264CC8AD7F9A4A95F99CFE]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_B5AD41879F264CC8AD7F9A4A95F99CFE_ss] ON [etl].[tmp_load_B5AD41879F264CC8AD7F9A4A95F99CFE] ([SourceSystem], [SSID])
GO
