CREATE TABLE [etl].[tmp_load_74B6905EDEBE46F9ADE8C7F1FFF6C472]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_74B6905EDEBE46F9ADE8C7F1FFF6C472_ss] ON [etl].[tmp_load_74B6905EDEBE46F9ADE8C7F1FFF6C472] ([SourceSystem], [SSID])
GO
