CREATE TABLE [etl].[tmp_load_5C0E5B4C972B4F1C848D659B098FFBA7]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_5C0E5B4C972B4F1C848D659B098FFBA7_ss] ON [etl].[tmp_load_5C0E5B4C972B4F1C848D659B098FFBA7] ([SourceSystem], [SSID])
GO
