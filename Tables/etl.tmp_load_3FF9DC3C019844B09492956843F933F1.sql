CREATE TABLE [etl].[tmp_load_3FF9DC3C019844B09492956843F933F1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_3FF9DC3C019844B09492956843F933F1_ss] ON [etl].[tmp_load_3FF9DC3C019844B09492956843F933F1] ([SourceSystem], [SSID])
GO
