CREATE TABLE [etl].[tmp_load_69DCDF194B49438F8A729B4C389CC51B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_69DCDF194B49438F8A729B4C389CC51B_ss] ON [etl].[tmp_load_69DCDF194B49438F8A729B4C389CC51B] ([SourceSystem], [SSID])
GO
