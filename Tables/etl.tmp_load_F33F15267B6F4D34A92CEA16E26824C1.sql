CREATE TABLE [etl].[tmp_load_F33F15267B6F4D34A92CEA16E26824C1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F33F15267B6F4D34A92CEA16E26824C1_ss] ON [etl].[tmp_load_F33F15267B6F4D34A92CEA16E26824C1] ([SourceSystem], [SSID])
GO
