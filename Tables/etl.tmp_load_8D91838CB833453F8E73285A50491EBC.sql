CREATE TABLE [etl].[tmp_load_8D91838CB833453F8E73285A50491EBC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_8D91838CB833453F8E73285A50491EBC_ss] ON [etl].[tmp_load_8D91838CB833453F8E73285A50491EBC] ([SourceSystem], [SSID])
GO
