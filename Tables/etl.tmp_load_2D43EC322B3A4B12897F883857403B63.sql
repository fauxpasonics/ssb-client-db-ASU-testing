CREATE TABLE [etl].[tmp_load_2D43EC322B3A4B12897F883857403B63]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_2D43EC322B3A4B12897F883857403B63_ss] ON [etl].[tmp_load_2D43EC322B3A4B12897F883857403B63] ([SourceSystem], [SSID])
GO
