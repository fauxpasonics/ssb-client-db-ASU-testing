CREATE TABLE [etl].[tmp_load_CB67A7D0D0964C568D38314CB40BBC6A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_CB67A7D0D0964C568D38314CB40BBC6A_ss] ON [etl].[tmp_load_CB67A7D0D0964C568D38314CB40BBC6A] ([SourceSystem], [SSID])
GO
