CREATE TABLE [etl].[tmp_load_AC8A9A6EDF3647C88A12744826CCC9CD]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_AC8A9A6EDF3647C88A12744826CCC9CD_ss] ON [etl].[tmp_load_AC8A9A6EDF3647C88A12744826CCC9CD] ([SourceSystem], [SSID])
GO
