CREATE TABLE [etl].[tmp_load_A925F2D5D2E7489680FF0F044C9FF672]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A925F2D5D2E7489680FF0F044C9FF672_ss] ON [etl].[tmp_load_A925F2D5D2E7489680FF0F044C9FF672] ([SourceSystem], [SSID])
GO
