CREATE TABLE [etl].[tmp_load_42A39C70CDC843B79F676681839FB0B6]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_42A39C70CDC843B79F676681839FB0B6_ss] ON [etl].[tmp_load_42A39C70CDC843B79F676681839FB0B6] ([SourceSystem], [SSID])
GO
