CREATE TABLE [etl].[tmp_load_708F1FBCCF5648049E3D9B218A1C8B16]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_708F1FBCCF5648049E3D9B218A1C8B16_ss] ON [etl].[tmp_load_708F1FBCCF5648049E3D9B218A1C8B16] ([SourceSystem], [SSID])
GO
