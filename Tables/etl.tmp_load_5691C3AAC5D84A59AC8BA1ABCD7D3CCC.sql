CREATE TABLE [etl].[tmp_load_5691C3AAC5D84A59AC8BA1ABCD7D3CCC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_5691C3AAC5D84A59AC8BA1ABCD7D3CCC_ss] ON [etl].[tmp_load_5691C3AAC5D84A59AC8BA1ABCD7D3CCC] ([SourceSystem], [SSID])
GO
