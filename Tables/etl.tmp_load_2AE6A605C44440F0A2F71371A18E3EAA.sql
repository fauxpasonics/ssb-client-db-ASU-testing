CREATE TABLE [etl].[tmp_load_2AE6A605C44440F0A2F71371A18E3EAA]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_2AE6A605C44440F0A2F71371A18E3EAA_ss] ON [etl].[tmp_load_2AE6A605C44440F0A2F71371A18E3EAA] ([SourceSystem], [SSID])
GO
