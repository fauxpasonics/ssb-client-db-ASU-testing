CREATE TABLE [etl].[tmp_load_3C6326F7B5F6464583C5576625041F26]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_3C6326F7B5F6464583C5576625041F26_ss] ON [etl].[tmp_load_3C6326F7B5F6464583C5576625041F26] ([SourceSystem], [SSID])
GO
