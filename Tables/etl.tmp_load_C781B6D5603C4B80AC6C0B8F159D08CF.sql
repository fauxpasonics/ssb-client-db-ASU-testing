CREATE TABLE [etl].[tmp_load_C781B6D5603C4B80AC6C0B8F159D08CF]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C781B6D5603C4B80AC6C0B8F159D08CF_ss] ON [etl].[tmp_load_C781B6D5603C4B80AC6C0B8F159D08CF] ([SourceSystem], [SSID])
GO
