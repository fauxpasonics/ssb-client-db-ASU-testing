CREATE TABLE [etl].[tmp_load_E00DC776EC7C49BCBBFB4EEE9A01A5D5]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_E00DC776EC7C49BCBBFB4EEE9A01A5D5_ss] ON [etl].[tmp_load_E00DC776EC7C49BCBBFB4EEE9A01A5D5] ([SourceSystem], [SSID])
GO
