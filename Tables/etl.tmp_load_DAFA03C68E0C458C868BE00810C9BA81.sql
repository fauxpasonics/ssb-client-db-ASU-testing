CREATE TABLE [etl].[tmp_load_DAFA03C68E0C458C868BE00810C9BA81]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_DAFA03C68E0C458C868BE00810C9BA81_ss] ON [etl].[tmp_load_DAFA03C68E0C458C868BE00810C9BA81] ([SourceSystem], [SSID])
GO
