CREATE TABLE [etl].[tmp_load_D6D709490C254744BB822A3763B16A52]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D6D709490C254744BB822A3763B16A52_ss] ON [etl].[tmp_load_D6D709490C254744BB822A3763B16A52] ([SourceSystem], [SSID])
GO
