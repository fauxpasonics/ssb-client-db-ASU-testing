CREATE TABLE [etl].[tmp_load_1A165B06CB604B38A3B9B08E5AAB66D1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1A165B06CB604B38A3B9B08E5AAB66D1_ss] ON [etl].[tmp_load_1A165B06CB604B38A3B9B08E5AAB66D1] ([SourceSystem], [SSID])
GO
