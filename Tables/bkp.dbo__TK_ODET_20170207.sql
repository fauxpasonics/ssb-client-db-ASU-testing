CREATE TABLE [bkp].[dbo__TK_ODET_20170207]
(
...
GO
ALTER TABLE [bkp].[dbo__TK_ODET_20170207] ADD CONSTRAINT [PK_TK_ODET] PRIMARY KEY CLUSTERED  ([ETLSID], [SEASON], [CUSTOMER], [SEQ])
GO
CREATE NONCLUSTERED INDEX [IDX_CUSTOMER] ON [bkp].[dbo__TK_ODET_20170207] ([CUSTOMER])
GO
CREATE NONCLUSTERED INDEX [IDX_I_PL] ON [bkp].[dbo__TK_ODET_20170207] ([I_PL])
GO
CREATE NONCLUSTERED INDEX [IDX_I_PT] ON [bkp].[dbo__TK_ODET_20170207] ([I_PT])
GO
CREATE NONCLUSTERED INDEX [IDX_ITEM] ON [bkp].[dbo__TK_ODET_20170207] ([ITEM])
GO
CREATE NONCLUSTERED INDEX [IDX_ORIG_SALECODE] ON [bkp].[dbo__TK_ODET_20170207] ([ORIG_SALECODE])
GO
CREATE NONCLUSTERED INDEX [IDX_SEASON] ON [bkp].[dbo__TK_ODET_20170207] ([SEASON])
GO
CREATE NONCLUSTERED INDEX [IDX_SEQ] ON [bkp].[dbo__TK_ODET_20170207] ([SEQ])
GO
