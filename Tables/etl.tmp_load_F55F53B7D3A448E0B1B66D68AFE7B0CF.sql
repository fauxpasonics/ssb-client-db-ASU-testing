CREATE TABLE [etl].[tmp_load_F55F53B7D3A448E0B1B66D68AFE7B0CF]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F55F53B7D3A448E0B1B66D68AFE7B0CF_ss] ON [etl].[tmp_load_F55F53B7D3A448E0B1B66D68AFE7B0CF] ([SourceSystem], [SSID])
GO
