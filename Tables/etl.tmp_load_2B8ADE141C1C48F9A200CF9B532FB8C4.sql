CREATE TABLE [etl].[tmp_load_2B8ADE141C1C48F9A200CF9B532FB8C4]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_2B8ADE141C1C48F9A200CF9B532FB8C4_ss] ON [etl].[tmp_load_2B8ADE141C1C48F9A200CF9B532FB8C4] ([SourceSystem], [SSID])
GO
