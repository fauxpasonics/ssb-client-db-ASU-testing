CREATE TABLE [etl].[tmp_load_B60C20EF98DB4A53A66CFC51237D5F1B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_B60C20EF98DB4A53A66CFC51237D5F1B_ss] ON [etl].[tmp_load_B60C20EF98DB4A53A66CFC51237D5F1B] ([SourceSystem], [SSID])
GO
