CREATE TABLE [etl].[tmp_load_BF059B5F46424257A5ED7DEEB8DAC8B0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_BF059B5F46424257A5ED7DEEB8DAC8B0_ss] ON [etl].[tmp_load_BF059B5F46424257A5ED7DEEB8DAC8B0] ([SourceSystem], [SSID])
GO
