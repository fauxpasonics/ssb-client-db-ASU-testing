CREATE TABLE [etl].[tmp_load_FA11260757C94299BCA162690246D79F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FA11260757C94299BCA162690246D79F_ss] ON [etl].[tmp_load_FA11260757C94299BCA162690246D79F] ([SourceSystem], [SSID])
GO
