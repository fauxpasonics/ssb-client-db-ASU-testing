CREATE TABLE [etl].[tmp_load_C0070FBE65FA44D294F31E2EA5BBEEBE]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C0070FBE65FA44D294F31E2EA5BBEEBE_ss] ON [etl].[tmp_load_C0070FBE65FA44D294F31E2EA5BBEEBE] ([SourceSystem], [SSID])
GO
