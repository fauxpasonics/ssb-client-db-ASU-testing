...
GO
ALTER TABLE [stg].[TM_AttendRealTime] ADD CONSTRAINT [PK__TM_Atten__C4EA2445A8D90B83] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
CREATE NONCLUSTERED INDEX [IDX_event_name] ON [stg].[TM_AttendRealTime] ([event_name])
GO
