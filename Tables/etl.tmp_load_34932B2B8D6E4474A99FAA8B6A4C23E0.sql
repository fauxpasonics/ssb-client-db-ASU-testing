CREATE TABLE [etl].[tmp_load_34932B2B8D6E4474A99FAA8B6A4C23E0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_34932B2B8D6E4474A99FAA8B6A4C23E0_ss] ON [etl].[tmp_load_34932B2B8D6E4474A99FAA8B6A4C23E0] ([SourceSystem], [SSID])
GO
