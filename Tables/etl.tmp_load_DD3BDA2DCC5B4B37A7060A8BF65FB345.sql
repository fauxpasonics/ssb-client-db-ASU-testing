CREATE TABLE [etl].[tmp_load_DD3BDA2DCC5B4B37A7060A8BF65FB345]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_DD3BDA2DCC5B4B37A7060A8BF65FB345_ss] ON [etl].[tmp_load_DD3BDA2DCC5B4B37A7060A8BF65FB345] ([SourceSystem], [SSID])
GO
