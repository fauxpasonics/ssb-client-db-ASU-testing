CREATE TABLE [etl].[tmp_load_C87678967A5B4B9E84B7B5553AC824C9]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C87678967A5B4B9E84B7B5553AC824C9_ss] ON [etl].[tmp_load_C87678967A5B4B9E84B7B5553AC824C9] ([SourceSystem], [SSID])
GO
