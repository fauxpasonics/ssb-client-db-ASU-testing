CREATE TABLE [etl].[TI_DimCustomer]
(
...
[DonorID] [nvarchar] (4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__TI_DimCus__CopyL__19DFD96B] DEFAULT (getdate())
)
GO
