CREATE TABLE [etl].[tmp_load_A2096EE3A5CF4F098B57B7F8C78BFB6D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A2096EE3A5CF4F098B57B7F8C78BFB6D_ss] ON [etl].[tmp_load_A2096EE3A5CF4F098B57B7F8C78BFB6D] ([SourceSystem], [SSID])
GO
