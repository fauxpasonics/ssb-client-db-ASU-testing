CREATE TABLE [etl].[tmp_load_ADCBBD1B4AE24B8F8318EB799C002780]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_ADCBBD1B4AE24B8F8318EB799C002780_ss] ON [etl].[tmp_load_ADCBBD1B4AE24B8F8318EB799C002780] ([SourceSystem], [SSID])
GO
