CREATE TABLE [etl].[tmp_load_EDD6700801C241EB84AF195AC9D44AC9]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_EDD6700801C241EB84AF195AC9D44AC9_ss] ON [etl].[tmp_load_EDD6700801C241EB84AF195AC9D44AC9] ([SourceSystem], [SSID])
GO
