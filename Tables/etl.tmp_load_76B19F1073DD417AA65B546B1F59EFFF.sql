CREATE TABLE [etl].[tmp_load_76B19F1073DD417AA65B546B1F59EFFF]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_76B19F1073DD417AA65B546B1F59EFFF_ss] ON [etl].[tmp_load_76B19F1073DD417AA65B546B1F59EFFF] ([SourceSystem], [SSID])
GO
