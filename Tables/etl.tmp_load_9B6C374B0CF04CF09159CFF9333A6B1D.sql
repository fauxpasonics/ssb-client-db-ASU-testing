CREATE TABLE [etl].[tmp_load_9B6C374B0CF04CF09159CFF9333A6B1D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_9B6C374B0CF04CF09159CFF9333A6B1D_ss] ON [etl].[tmp_load_9B6C374B0CF04CF09159CFF9333A6B1D] ([SourceSystem], [SSID])
GO
