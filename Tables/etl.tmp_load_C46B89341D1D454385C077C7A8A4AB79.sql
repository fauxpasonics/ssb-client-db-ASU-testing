CREATE TABLE [etl].[tmp_load_C46B89341D1D454385C077C7A8A4AB79]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C46B89341D1D454385C077C7A8A4AB79_ss] ON [etl].[tmp_load_C46B89341D1D454385C077C7A8A4AB79] ([SourceSystem], [SSID])
GO
