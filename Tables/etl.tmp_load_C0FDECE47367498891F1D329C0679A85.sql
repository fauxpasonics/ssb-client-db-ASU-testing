CREATE TABLE [etl].[tmp_load_C0FDECE47367498891F1D329C0679A85]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C0FDECE47367498891F1D329C0679A85_ss] ON [etl].[tmp_load_C0FDECE47367498891F1D329C0679A85] ([SourceSystem], [SSID])
GO
