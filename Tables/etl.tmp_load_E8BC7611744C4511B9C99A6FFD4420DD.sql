CREATE TABLE [etl].[tmp_load_E8BC7611744C4511B9C99A6FFD4420DD]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_E8BC7611744C4511B9C99A6FFD4420DD_ss] ON [etl].[tmp_load_E8BC7611744C4511B9C99A6FFD4420DD] ([SourceSystem], [SSID])
GO
