CREATE TABLE [etl].[tmp_load_19A6AFFE0DD14E3B8A42A27BD644C00E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_19A6AFFE0DD14E3B8A42A27BD644C00E_ss] ON [etl].[tmp_load_19A6AFFE0DD14E3B8A42A27BD644C00E] ([SourceSystem], [SSID])
GO
