CREATE TABLE [etl].[tmp_load_D1FB41B6EDE5461C85789C4C6C4AEA81]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D1FB41B6EDE5461C85789C4C6C4AEA81_ss] ON [etl].[tmp_load_D1FB41B6EDE5461C85789C4C6C4AEA81] ([SourceSystem], [SSID])
GO
