CREATE TABLE [etl].[tmp_load_57FE73DD89B943479DAAB682B9664F8A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_57FE73DD89B943479DAAB682B9664F8A_ss] ON [etl].[tmp_load_57FE73DD89B943479DAAB682B9664F8A] ([SourceSystem], [SSID])
GO
