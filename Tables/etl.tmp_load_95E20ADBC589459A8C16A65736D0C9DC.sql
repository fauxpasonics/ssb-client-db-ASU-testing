CREATE TABLE [etl].[tmp_load_95E20ADBC589459A8C16A65736D0C9DC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_95E20ADBC589459A8C16A65736D0C9DC_ss] ON [etl].[tmp_load_95E20ADBC589459A8C16A65736D0C9DC] ([SourceSystem], [SSID])
GO
