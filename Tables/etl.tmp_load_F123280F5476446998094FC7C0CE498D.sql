CREATE TABLE [etl].[tmp_load_F123280F5476446998094FC7C0CE498D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F123280F5476446998094FC7C0CE498D_ss] ON [etl].[tmp_load_F123280F5476446998094FC7C0CE498D] ([SourceSystem], [SSID])
GO
