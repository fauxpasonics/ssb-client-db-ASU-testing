CREATE TABLE [etl].[tmp_load_D461FE4ACE054F72B2D99DB81B9D5278]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D461FE4ACE054F72B2D99DB81B9D5278_ss] ON [etl].[tmp_load_D461FE4ACE054F72B2D99DB81B9D5278] ([SourceSystem], [SSID])
GO
