CREATE TABLE [etl].[tmp_load_6A40C067E57F4CB489FC780EB6C114BD]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6A40C067E57F4CB489FC780EB6C114BD_ss] ON [etl].[tmp_load_6A40C067E57F4CB489FC780EB6C114BD] ([SourceSystem], [SSID])
GO
