CREATE TABLE [etl].[tmp_load_17D1BFDAC50049AC921F10CF05275C3D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_17D1BFDAC50049AC921F10CF05275C3D_ss] ON [etl].[tmp_load_17D1BFDAC50049AC921F10CF05275C3D] ([SourceSystem], [SSID])
GO
