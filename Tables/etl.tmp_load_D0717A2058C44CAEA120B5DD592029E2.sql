CREATE TABLE [etl].[tmp_load_D0717A2058C44CAEA120B5DD592029E2]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D0717A2058C44CAEA120B5DD592029E2_ss] ON [etl].[tmp_load_D0717A2058C44CAEA120B5DD592029E2] ([SourceSystem], [SSID])
GO
