CREATE TABLE [etl].[tmp_load_17373BC8F4924B2ABC6A8A91D2B45F1A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_17373BC8F4924B2ABC6A8A91D2B45F1A_ss] ON [etl].[tmp_load_17373BC8F4924B2ABC6A8A91D2B45F1A] ([SourceSystem], [SSID])
GO
